...
System.out.println("ap view1 issssssssssssssssssss"+ap);
	String bname=(String)session.getAttribute("unamep");
	//session.setAttribute("owner_name",b);
	System.out.println("b view1 page isssssssssssss"+bname);
...
%>
							  ...
							  <form action="decrypt.jsp" method="get">
								<br><br>
										<fieldset
											...
											<table width="350" align="center">
												...
												<br></br>
												<tr>
													<td><font color="white" size="4">Decrypt Key:</font></td>
													<td><input type="text"  name="key"  id="name"
												...
												<tr></tr>
												 <tr>
            <td></td>
            <td><input type="submit" name="submit" id="submit" value="Login" style="background-color: white; color: #000000; font-size: 18px; border-radius: 10px;" /></td>
          </tr>
													<tr></tr>
												<tr></tr>
												<tr></tr>
