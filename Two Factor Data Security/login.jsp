	...
	<div class="main">
			...
			<div class="header_resize">
				...
				<div class="menu_nav">
					<ul>
						...
						<li class="active"><a href="login.jsp"><span>User Login</span></a></li>
						<li><a href="ologin.jsp"><span>Owner Login</span></a></li>
						<li><a href="adminlogin.jsp"><span>Admin Login</span></a></li>
		...
		<div class="content">
			<div class="content_resize">
				<div class="mainbar">
					<div class="article">
						<h2 align="center">User Login Here</h2>
						<div class="clr"></div>
						<div class="post_content" align="center">
							<form method="post" name="contact" action="userlogin.jsp">
								<br><br>
										<fieldset
											...
											<legend>
												<font size="4" style="font-weight: 900;" color="blue">Login
													Here</font>
											</legend>
											<table width="350" align="center">
												...
												<tr>
													...
													<td><input type="text" name="uname" id="name"
												...
												<tr></tr>
												<tr>
													<td><font color="white" size="4">Password:</font></td>
											...
											<font color="white" size="3">If New User Register Here </font> <a href="register.jsp"><img src="images/reg.gif" align="center" width="150" height="30"></img></a>
										</fieldset>
							</form>
						</div>
					</div>
