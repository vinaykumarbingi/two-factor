	...
	<div class="main">
			...
			<div class="header_resize">
				...
				<div class="menu_nav">
					<ul>
						...
						<li  class="active"><a href="ownerreg.jsp"><span>Register</span></a></li>
		...
		<div class="content">
			<div class="content_resize">
				<div class="mainbar">
					<div class="article">
						<h2 align="center">Owner Registration Page</h2>
						<div class="clr"></div>
						<div class="post_content" align="center">
							 <form action="ownerreg1.jsp" method="post">
								...
								<fieldset
									...
									<legend>
										<font size="4" style="font-weight: 900;" color="blue">Register
											Here</font>
									</legend>
								...
								<br>
										...
										<tr>
											<td><font size="4" color="white">Date of Birth:</font></td>
											<td><input type="text" name="dob" id='datetimepicker4'
												style="background-color: white; color: #000000; font-size: 18px; border-radius: 10px;"></td>
									</tr>
										<tr>
											<td><font size="4" color="white">Mobile No:</font></td>
											<td><input type="text" name="phone" id="phone"
												style="background-color: white; color: #000000; font-size: 18px; border-radius: 10px;"></td>
										</tr>
										<tr>
											<td><font size="4" color="white">Address:</font></td>
											<td><textarea rows="4" cols="20" name="address" style="background-color: white; color: #000000; font-size: 18px; border-radius: 10px;"></textarea>
												</td>
										</tr>
										<tr>
