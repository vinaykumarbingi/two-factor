...
<%@page import="java.sql.*,java.math.*,java.lang.*,databaseconnection.*,java.text.SimpleDateFormat,java.util.*,java.io.*" %>
							...
							<form method="post" name="contact" action="insertprofile2.jsp">
								...
								<br><br></br>
										<tr>
											...
											<td><input type="text" name="name" id="name" value="<%=request.getParameter("name")%>"
												style="background-color: white; color: #000000; font-size: 18px; border-radius: 10px;"></td>
										</tr>
										
										<tr>
											<td><font size="4" color="white">Secret Key:</font></td>
											<td><input type="text" name="pkey" id="name" value="<%=y%>"
											style="background-color: white; color: #000000; font-size: 18px; border-radius: 10px;"></td>
										</tr>
										<tr>
											<td></td>
