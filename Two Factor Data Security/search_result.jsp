		...
		<div class="content">
			<div class="content_resize">
				...
				<tr>
				 ...
				 <td width="65"  bgcolor="#808000"><font color="#FFFFFF" face="Monotype Corsiva, Arial" size="+1"><b>Index_keyword</b></font></td>
            <td width="50" bgcolor="#808000"><p><font color="#FFFFFF" face="Monotype Corsiva, Arial" size="+1"><b>Ranked Score</b>  </font></p></td>
                 <td width="50" bgcolor="#808000"><p><font color="#FFFFFF" face="Monotype Corsiva, Arial" size="+1"><b>Download</b></font></p></td>
...
String x="waiting";
int id=0;
String op=null,ol=null;
String kk=request.getParameter("keyword");

try
{
Connection con = databasecon.getconnection();
PreparedStatement ps=con.prepareStatement("select * from up where  indexx like '%"+kk+"%' ORDER BY score DESC");
ResultSet rs=ps.executeQuery();
	
while(rs.next())
 {
 String oo=rs.getString("fid");
 session.setAttribute("fid",oo);
 String fname=rs.getString("fname");
 session.setAttribute("fname",fname);
op=rs.getString("indexx1");
ol=rs.getString("score");
String ol1=rs.getString("file");
session.setAttribute("uu",ol1);
String ol2=rs.getString("ff");
session.setAttribute("uu1",ol2);

Integer ooid=rs.getInt("oid");
session.setAttribute("ooid",ooid);
System.out.println("ooid issssssssssssssssssss"+ooid);
 ...
 %>			<tr  bgcolor="#FFCCFF"> 
		  <td bgcolor="#FFCCFF"> 
             <font color="#000000" face="Monotype Corsiva, Arial" size="4"><%=op%></font>
            </td>
            	  <td bgcolor="#FFCCFF"> 
              <font color="#000000" face="Monotype Corsiva, Arial" size="4"><%=ol%></font>
            </td>
      	  
         	 
			
            
				  <td bgcolor="#FFCCFF">  <a href="view.jsp?as=<%=id%>"><font color="#000000" face="Monotype Corsiva", Arial; size="4">View the File</font></a></td>
          </tr>
				 <%
